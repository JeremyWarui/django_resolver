...
USERS = [
    ...
    # KSM technicians
    (
        "ksm_syssupport_tech1",
        "Erick",
        "Okoth",
        "ksm.ict.syssupp.tech1@ksg.local",
        "KSM",
    ),
    # Requesters
...
CATALOGUE = [
    ...
    ("ADM", "TRANS", "Transport Services", False, 2, ["Vehicle Booking Services"]),
    (
        "HR",
        "PAYROLL",
        "Payroll Services",
    ...
    ("HR", "REG", "Registry Services", False, 1, ["File Services"]),
    (
        "ICT",
        "NET",
        "Network Services",
    ...
    ("ICT", "SYSSUPP", "Systems Support", False, 2, ["ERP Services", "Email Services"]),
]
...
class Command(BaseCommand):
    ...
    def _seed_campuses(self):
        ...
        for c in CAMPUSES:
            ...
            if is_new:
                created += 1
        self.stdout.write(
            f"  Campus: {created} created, {len(CAMPUSES) - created} existed"
        )
        return campuses
    ...
    def _seed_departments(self):
        ...
        for d in DEPARTMENTS:
            ...
            if is_new:
                created += 1
        self.stdout.write(
            f"  Department: {created} created, {len(DEPARTMENTS) - created} existed"
        )
        return departments
    ...
    def _seed_users(self, campuses):
        ...
        for username, first_name, last_name, email, campus_code in USERS:
            ...
            UserProfile.objects.get_or_create(
                user=user, defaults={"campus": campuses[campus_code]}
            )
            users[username] = user
    ...
    def _seed_campus_departments(self, campuses, departments, users):
        ...
        for campus_code, dept_code, hod_username in CAMPUS_DEPARTMENTS:
            ...
            if is_new:
                created += 1
        self.stdout.write(
            f"  CampusDepartment: {created} created, {len(CAMPUS_DEPARTMENTS) - created} existed"
        )
        return campus_depts
    ...
    def _seed_sections(self, campus_depts, section_types, users):
        ...
        for campus_code, dept_code, st_code, hos_username, is_active in SECTIONS:
            ...
            if is_new:
                created += 1
        self.stdout.write(
            f"  Section: {created} created, {len(SECTIONS) - created} existed"
        )
        return sections
    ...
    def _seed_tickets(self, users, sections):
        ...
        t01 = make_ticket(
            raised_by=u["alice.kamau"],
            requester_campus=nrb,
            service_item=plumbing,
            priority=p[2],
            section=s_adm_maint,
            status="open",
            ...
            created_at=d(0, hour=8),
            updated_at=d(0, hour=8),
        )
        make_log(t01, "created", "", "open", created_at=d(0, hour=8))

        # T02 — assigned (yesterday)
        t02 = make_ticket(
            raised_by=u["carol.njoki"],
            requester_campus=nrb,
            service_item=electrical,
            priority=p[3],
            section=s_adm_maint,
            status="assigned",
            current_level="technician",
            assigned_to=u["nrb_maint_tech1"],
            ...
            created_at=d(1, hour=9),
            updated_at=d(1, hour=10),
        )
        ...
        make_log(
            ...
            "open",
            "assigned",
            actor=u["nrb_maint_tech1"],
            created_at=d(1, hour=10),
        )

        # T03 — in_progress (2 days ago)
        t03 = make_ticket(
            raised_by=u["eve.wanjiru"],
            requester_campus=nrb,
            ...
            created_at=d(2, hour=10),
            updated_at=d(2, hour=14),
        )
        ...
        make_log(
            ...
            "open",
            "assigned",
            actor=u["nrb_maint_tech2"],
            created_at=d(2, hour=11),
        )
        make_log(
            t03,
            "status_changed",
        ...
        t04 = make_ticket(
            ...
            created_at=d(7, hour=8),
            updated_at=d(5, hour=16),
        )
        ...
        make_log(
            ...
            "pending",
            actor=u["nrb_maint_tech1"],
            reason="Awaiting spare pipe fittings delivery",
            created_at=d(5, hour=16),
        )
        ...
        t05 = make_ticket(
            ...
            created_at=d(8, hour=9),
            updated_at=d(8, hour=16),
        )
        ...
        make_log(
            ...
            "resolved",
            actor=u["nrb_maint_tech2"],
            created_at=d(8, hour=16),
        )
        TicketFeedback.objects.create(
            ticket=t05, rating=5, comment="Fixed within hours, very professional."
        )
        ...
        t06 = make_ticket(
            ...
            created_at=d(9, hour=8),
            updated_at=d(7, hour=9),
        )
        ...
        t08 = make_ticket(
            ...
            status="assigned",
            current_level="technician",
            assigned_to=u["nrb_transport_tech1"],
            ...
            created_at=d(1, hour=8),
            updated_at=d(1, hour=11),
        )
        ...
        make_log(
            ...
            "open",
            "assigned",
            actor=u["nrb_transport_tech1"],
            created_at=d(1, hour=11),
        )
        ...
        t09 = make_ticket(
            ...
            created_at=d(5, hour=9),
            updated_at=d(4, hour=15),
        )
        ...
        make_log(
            ...
            "pending",
            actor=u["nrb_transport_tech1"],
            reason="Pending Finance department approval for hire charges",
            created_at=d(4, hour=15),
        )
        ...
        t10 = make_ticket(
            ...
            created_at=d(8, hour=7),
            updated_at=d(6, hour=9),
        )
        ...
        make_log(
            ...
            "resolved",
            "closed",
            actor=u["nrb_transport_hos"],
            created_at=d(6, hour=9),
        )
        ...
        t11 = make_ticket(
            ...
            created_at=d(0, hour=9),
            updated_at=d(0, hour=9),
        )
        ...
        make_log(
            ...
            "open",
            "assigned",
            actor=u["nrb_payroll_tech1"],
            created_at=d(2, hour=12),
        )
        make_log(
            t12,
            "status_changed",
        ...
        make_log(
            ...
            "open",
            "assigned",
            actor=u["nrb_payroll_tech2"],
            created_at=d(5, hour=10),
        )
        make_log(
            t13,
            "status_changed",
        ...
        make_log(
            ...
            "pending",
            actor=u["nrb_payroll_tech2"],
            reason="Pending confirmation from Payroll Officer on deduction category",
            created_at=d(3, hour=14),
        )
        ...
        make_log(
            ...
            "resolved",
            actor=u["nrb_payroll_tech1"],
            created_at=d(6, hour=16),
        )
        TicketFeedback.objects.create(
            ticket=t14, rating=4, comment="Processed efficiently, good follow-up."
        )
        ...
        t15 = make_ticket(
            ...
            created_at=d(1, hour=14),
            updated_at=d(1, hour=14),
        )
        ...
        make_log(
            ...
            "open",
            "assigned",
            actor=u["nrb_registry_tech1"],
            created_at=d(2, hour=13),
        )
        ...
        t17 = make_ticket(
            ...
            created_at=d(3, hour=10),
            updated_at=d(3, hour=15),
        )
        ...
        t18 = make_ticket(
            ...
            created_at=d(9, hour=9),
            updated_at=d(6, hour=10),
        )
        ...
        make_log(
            ...
            "resolved",
            "closed",
            actor=u["nrb_registry_hos"],
            created_at=d(6, hour=10),
        )
        ...
        t19 = make_ticket(
            ...
            created_at=d(0, hour=7),
            updated_at=d(0, hour=7),
        )
        ...
        t20 = make_ticket(
            ...
            status="in_progress",
            current_level="technician",
            assigned_to=u["nrb_networks_tech1"],
            response_due_at=d(1) + timedelta(minutes=240),
            resolution_due_at=d(1) + timedelta(minutes=1440),
        ...
        t21 = make_ticket(
            ...
            status="in_progress",
            current_level="hos",
            assigned_to=u["nrb_networks_tech2"],
        ...
        make_log(
            ...
            "technician",
            "hos",
            level_user=u["nrb_networks_hos"],
            reason="Unresolved after 4 hours — escalating to HOS",
            created_at=d(4, hour=9),
        )
        ...
        make_log(
            ...
            "resolved",
            actor=u["nrb_networks_tech1"],
            created_at=d(5, hour=17),
        )
        TicketFeedback.objects.create(
            ticket=t22, rating=5, comment="Configured same day, no downtime."
        )
        ...
        t23 = make_ticket(
            ...
            status="closed",
            current_level="technician",
            assigned_to=u["nrb_networks_hos"],
            ...
            created_at=d(8, hour=11),
            updated_at=d(7, hour=10),
        )
        ...
        make_log(
            ...
            "open",
            "assigned",
            actor=u["nrb_syssupport_tech1"],
            created_at=d(1, hour=12),
        )
        ...
        make_log(
            ...
            "open",
            "assigned",
            actor=u["nrb_syssupport_tech2"],
            created_at=d(3, hour=9),
        )
        make_log(
            t26,
            "status_changed",
        ...
        t27 = make_ticket(
            ...
            created_at=d(7, hour=7),
            updated_at=d(6, hour=8),
        )
        ...
        make_log(
            ...
            "technician",
            "hos",
            level_user=u["nrb_syssupport_hos"],
            reason="Not resolved in 4 hours — escalating",
            created_at=d(7, hour=13),
        )
        make_log(
            t27,
            "escalated",
            "hos",
            "hod",
            level_user=u["nrb_ict_hod"],
            reason="Requires executive sign-off on ERP vendor engagement",
            created_at=d(6, hour=8),
        )
        ...
        t29 = make_ticket(
            raised_by=u["bob.mwenda"],
            requester_campus=msa,
            service_item=loan,
            priority=p[2],
            section=s_msa_hr_pay,
            status="resolved",
            current_level="technician",
            assigned_to=u["msa_payroll_hos"],
            response_due_at=d(6) + timedelta(minutes=240),
            resolution_due_at=d(6) + timedelta(minutes=1440),
        ...
        make_log(
            ...
            "open",
            "assigned",
            actor=u["msa_payroll_hos"],
            created_at=d(6, hour=11),
        )
        make_log(
            t29,
            "resolved",
        ...
        TicketFeedback.objects.create(
            ticket=t29,
            rating=4,
            comment="Resolved promptly despite cross-campus request.",
        )
    ...
    def _seed_ticket_locations(self):
        ...
        LOCATIONS = [
            (
                ...
                "NRB-AB-A",
                ft_office,
                {"floor": "1", "room": "101", "area": "Plumbing riser"},
            ),
            (
                "TKT-NRB-ADM-0002",
                "NRB-FIN",
                ft_office,
                {"floor": "2", "room": "Finance Lab", "area": "Server room"},
            ),
            (
                "TKT-NRB-ADM-0003",
                "NRB-MH",
                ft_building,
                {"floor": "Ground", "room": "Stage", "area": "Roof support"},
            ),
            (
                "TKT-NRB-ADM-0004",
                "NRB-CC",
                ft_building,
                {"floor": "1", "room": "Board Room", "area": "Washroom"},
            ),
            (
                "TKT-NRB-ADM-0005",
                "NRB-AB-B",
                ft_office,
                {"floor": "3", "room": "305", "area": "Electrical panel"},
            ),
            (
                "TKT-NRB-ADM-0006",
                "NRB-SC",
                ft_building,
                {"floor": "Ground", "room": "Kitchen", "area": "Ceiling boards"},
            ),
        ]
