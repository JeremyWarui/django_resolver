        ...
        report_types = [
            {
                ...
                'filters': ['start_date', 'end_date', 'status', 'section_id', 'technician_id'],
                'columns': [
                    'Ticket No', 'Title', 'Section', 'Facility', 'Raised By',
                    'Assigned To', 'Status', 'Created At', 'Resolved At',
                    'Resolution Time', 'Pending Reason'
                ]
            },
            {
                ...
                'columns': [
                    ...
                    'Pending', 'In Progress', 'Avg Resolution Time', 'Avg Rating'
                ]
            },
            {
                'id': 'facility-health',
                ...
                'columns': [
                    ...
                    'Open Tickets', 'Avg Response Time', 'Status'
                ]
            },
            {
                'id': 'pending-analysis',
                ...
                'columns': [
                    ...
                    'Created At', 'Updated At', 'Pending Duration',
