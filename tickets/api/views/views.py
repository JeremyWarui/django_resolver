...
class DepartmentListCreateView(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = Department.objects.select_related(
            "campus", "campus__organization", "head_of_department"
        ).all()
        user = self.request.user
    ...
    def get_queryset(self):
        ...
        try:
            section = Section.objects.select_related(
                "department", "department__campus", "department__campus__organization"
            ).get(id=section_id)
        ...
        try:
            data = {
                "ticket_counts": TicketAnalytics.get_ticket_counts_by_timeframe(
                    days=days, facility_id=facility_id, section_id=section_id
                ),
