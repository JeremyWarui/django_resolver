...
def test_ticket_creation(ticket_factory, user_factory, technician_factory, section, facility):
...
def test_ticket_change_assignment_creates_log(db, ticket_factory, user_factory, technician_factory):
